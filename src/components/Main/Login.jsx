    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-100 p-4">
      <div className="w-full max-w-md bg-white rounded-xl shadow-lg p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <Input label="Email" type="email" inputRef={emailRef} id="email" name="email" required />
          <Input label="Password" type="password" inputRef={passwordRef} id="password" name="password" required />
          <Button disabled={loading} type="submit" title="Log in" className="w-full" />
        </form>
